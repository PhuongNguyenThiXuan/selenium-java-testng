...
public class Topic_11_Multiple_Platform {
    WebDriver driver;
    String environmentURL;
    Platform platform;

    @Parameters({"browser", "environmentName", "platformName"}) //truyen name cua parameter
    @BeforeClass
    public void beforeClass(String browserName, String environmentName, String platformName){
